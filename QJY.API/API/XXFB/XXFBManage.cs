...
namespace QJY.API
{
    public class XXFBManage
    {
        ...
        public void GETXXFBTYPELISTWX(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        public void GETXXFBTYPELISTALL(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        //获取接收的发布信息,已审核过的信息
        public void GETXXFBLISTWX(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int page = 0;
            int pagecount = 8;
            ...
            string strWhere = string.Format("SZHL_XXFB.ComId='{0}'  and IsSend='1' and MsgType=1 and (((SHstatus='2' and   (     " + SqlHelp.concat("','+SZHL_XXFB.JSUser+','") + "    LIKE '%,{1},%' or  SZHL_XXFB.JSUser='')) and FBTime<='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "') or (SHStatus=0 and SHUser='{1}')or (SHStatus=1 and SZHL_XXFB.CRUser='{1}')) ", UserInfo.User.ComId, UserInfo.User.UserName);
            if (P1 != "")
            {
        ...
        //获取需要审核的信息
        public void GETXXFBLISTWXSH(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int page = 0;
            int.TryParse(context["p"] == null ? "0" : context["p"].ToString(), out page);
            //
            string strWhere = string.Format("SZHL_XXFB.ComId='{0}'  and IsSend=1 and MsgType=1 and FBTime<='{1}' ", UserInfo.User.ComId, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        ...
        //获取信息详情 PC微信共同使用
        public void GETXXFBMODELWX(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int Id = int.Parse(P1);
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void GETXXFBTYPELIST(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void GETXXFBTYPELISTPAGE(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int page = 0;
            int pagecount = 8;
            int.TryParse(context["p"] == null ? "1" : context["p"].ToString(), out page);
            int.TryParse(context["pagecount"] == null ? "8" : context["pagecount"].ToString(), out pagecount);//页数
            int recordCount = 0;
            ...
            DataTable dt = new SZHL_XXFBTypeB().Db.Queryable<SZHL_XXFBType>().Where(strWhere).Select(" ID,TypeName,TypeDec,TypeManager,ISzjfb,CheckUser,SeeUser,IsCheck,IsSee,PTypeID ").OrderBy(it => it.CRDate, OrderByType.Desc).ToPageList(page, pagecount, ref recordCount).ToDataTable();
        ...
        //获取管理员所管理的类型列表
        public void GETXXFBCHILDRENMANAGE(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            ...
            if (allTypeList.Count > 0)
            {
                ...
                string strSql = string.Format("SELECT * from SZHL_XXFBType where   " + SqlHelp.concat("','+TypeManager+','") + " like '%,{0},%'and Id not in ({1}) and ComId={2} and isDel=0 order by PTypeID", UserInfo.User.UserName, pIds, UserInfo.User.ComId);
        ...
        //获取所有子项列表
        public void GETXXFBCHILDREN(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        //获取所有子项列表
        public void GETXXFBUSERCHILDREN(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            string strSql = string.Format(@"SELECT  DISTINCT type.* from SZHL_XXFBType type  inner join SZHL_XXFB  xxfb on type.ID=xxfb.XXFBType 
                                            where xxfb.ComId={0} and   " + SqlHelp.concat("','+xxfb.JSUser+','") + "  LIKE '%,{1},%'", UserInfo.User.ComId, UserInfo.User.UserName);
        ...
        public void GETXXFBMODEL(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int Id = int.Parse(P1);
        ...
        public void ADDXXFBTYPE(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        public void GETXXFBTYPE(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int Id = int.Parse(P1);
            msg.Result = new SZHL_XXFBTypeB().GetEntity(d => d.ID == Id);
        }
        public void DELXXFBTYPE(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int ID = int.Parse(P1);
        ...
        //获取接收人列表
        public void GETXXFBUSERLIST(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int id = 0;
        ...
        public void ADDXXFB(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        //修改信息发布
        public void XXFBMODIFY(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            SZHL_XXFB xxmodel = JsonConvert.DeserializeObject<SZHL_XXFB>(P1);
            string JsUser = xxmodel.JSUser;
            List<SZHL_XXFB_ITEM> xxfbList = JsonConvert.DeserializeObject<List<SZHL_XXFB_ITEM>>(P2);
        ...
        //获取企业信息的多图文列表
        public void GETXXFBITEMLIST(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        //获取接收的发布信息
        public void GETXXFBLIST(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int page = 0;
            int pagecount = 8;
            int.TryParse(context["p"] == null ? "1" : context["p"].ToString(), out page);
            ...
            string type = context["type"] != null ? context["type"].ToString() : "";
            if (type == "1") //我接收的
            {
                strWhere += string.Format(" and SHStatus=2  and (  " + SqlHelp.concat("','+SZHL_XXFB.JSUser+','") + "   LIKE '%,{0},%' or  SZHL_XXFB.JSUser='') and FBTime<'{1}'", UserInfo.User.UserName, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
            }
            else
            {//我创建的
                strWhere += string.Format("  and  SZHL_XXFB.CRUser='{0}' ", UserInfo.User.UserName);
        ...
        //获取自己创建的发布信息及草稿
        public void GETXXFBLISTUSER(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int page = 0;
            int.TryParse(context["p"] == null ? "1" : context["p"].ToString(), out page);
        ...
        //获取需要登录人审核的数据
        public void GETXXFBLISTDSH(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int page = 0;
            int.TryParse(context["p"] == null ? "1" : context["p"].ToString(), out page);
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void SHXXFB(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            string strSql = string.Format("UPDATE SZHL_XXFB set SHStatus={0} ,SHYJ='{1}',SHDate='{4}' where ID in ({2}) and ComId={3}", P2, context["jy"] != null ? context["jy"].ToString() : "", P1, UserInfo.User.ComId, DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        ...
        public void SUREXXFB(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            //更新审核状态
            int Id = int.Parse(P1);
            SZHL_XXFB model = new SZHL_XXFBB().GetEntity(d => d.ID == Id);
        ...
        public void GETSHXXFBLIST(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int page = 0;
            int.TryParse(context["p"] == null ? "1" : context["p"].ToString(), out page);
            string strWhere = string.Format(" fgtype.IsCheck='True'  and  " + SqlHelp.concat("','+fgtype.CheckUser+','") + "   LIKE '%,{0},%'  and fb.ComId={1} and fb.MsgType=1", UserInfo.User.UserName, UserInfo.User.ComId);
            int recordCount = 0;
        ...
        public void UPXXFBREADUSER(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int Id = int.Parse(P1);
        ...
        public void DELDRAFTS(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int ID = int.Parse(P1);
        ...
        public void GETDRAFTLIST(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        //保存为自己的素材
        public void SETSCUSER(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int ID = int.Parse(P1);
        ...
        //撤回信息发布
        public void DELETEXXFB(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int id = int.Parse(P1);
        ...
        //获取自己的素材信息列表
        public void GETMATTERDRAFTLIST(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        public void SENDWXMSG(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        //发送审核消息
        public void SENDWXMSGCHECK(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            var tx = JsonConvert.DeserializeObject<SZHL_TXSX>(P1);
        ...
        public void SENDWXMSGSRTX(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            try
            {
                var tx = JsonConvert.DeserializeObject<SZHL_TXSX>(P1);
        ...
        //删除素材
        public void DELMATTER(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int Id = int.Parse(P1);
            SZHL_XXFB xxfb = new SZHL_XXFBB().GetEntity(d => d.ID == Id);
        ...
        #region 素材库
        public void ADDSCCONTENT(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        //获取素材列表
        public void GETSCLIST(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        public void DELETESCMODEL(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int Id = int.Parse(P1);
        ...
        public void GETXXFBTYPETOP(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            //获取信息发布分类下的第一条公告
            DataTable dt = new SZHL_XXFBB().GetDTByCommand("  SELECT  XXFBType AS typeId, MAX(ID) AS ID from szhl_xxfb WHERE  " + SqlHelp.concat("','+JSUser+','") + "   like '%,"+ UserInfo.User.UserName + ",%' GROUP BY   XXFBType ");
            dt.Columns.Add("TypeName");
            dt.Columns.Add("XXTitle");
            dt.Columns.Add("CRDate");
            ...
            foreach (DataRow row in dt.Rows)
            {
                if (!string.IsNullOrEmpty(row["ID"].ToString()))
                {
                    ...
                    SZHL_XXFB fb = new SZHL_XXFBB().GetEntity(d => d.ID == ID);
                    SZHL_XXFBType type = new SZHL_XXFBTypeB().GetEntity(d => d.ID == fb.XXFBType);
                    row["XXTitle"] = fb.XXTitle;
                    row["TypeName"] = type.TypeName;
                    row["CRDate"] = fb.CRDate.Value.ToString("yyyy-MM-dd HH:mm:ss");
        ...
        public void GETXXFBBYUSER(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            string strSql = string.Format("select * from SZHL_XXFBType xxfb where  (  " + SqlHelp.concat("','+xxfb.TypeManager+','") + "   LIKE '%,{0},%')  and ComId={1} and PTypeID!='0' and isDel=0 and  IsCheck='false' ", UserInfo.User.UserName, UserInfo.User.ComId);//and Type={1} 
            msg.Result = new SZHL_XXFBTypeB().GetDTByCommand(strSql);
        }
        public void ADDXXFBM(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            SZHL_XXFB xxmodel = JsonConvert.DeserializeObject<SZHL_XXFB>(P1);
            string JsUser = xxmodel.JSUser;
