...
namespace QJY.API
{
    public class XZGLManage
    {
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void DELFFJL(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            if (P1 != "")//PIID
            {
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void TJGZD(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void GETSYFFJL(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            var dt = new SZHL_XZ_JLB().GetEntities(it => it.CRUser == UserInfo.User.UserName).OrderByDescending(d => d.CRDate).Take(1);
            msg.Result = dt;
        }
        /// <summary>
        /// 最近上传的4条工资单
        ...
        /// <param name="P2"></param>
        /// <param name="strUserName"></param>
        public void ADDJCSZ(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void GETJCSZMODEL(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int Id = 0;
            int.TryParse(P1, out Id);
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void ADDFL(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
