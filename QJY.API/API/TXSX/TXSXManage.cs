...
namespace QJY.API
{
    public class TXSXManage
    {
        ...
        public void ADDTXSX(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            ...
            if (txsx.ID == 0)
            {
                txsx.TXMode = "TXSX";
                txsx.WXLink = "";
                string strID = context["ID"] != null ? context["ID"].ToString() : "";
                string strCode = context["Code"] != null ? context["Code"].ToString() : "";
                string strType = context["Type"] != null ? context["Type"].ToString() : "";
                txsx.WXLink = "A";
        ...
        public void GETTXSXLIST(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            string userName = UserInfo.User.UserName;
            string strWhere = " Remark='Manual' and ComId=" + UserInfo.User.ComId;

            string type = context["lb"] != null ? context["lb"].ToString() : "1";
            if (type == "1")
            {
            ...
            {
                strWhere += string.Format(" And  " + SqlHelp.concat("','+TXUser+','") + "   like '%,{0},%'", userName);
            }
            ...
            int DataID = -1;
            int.TryParse(context["ID"] != null ? context["ID"].ToString() : "-1", out DataID);//记录Id
            if (DataID != -1)
            {
            ...
            dt = new SZHL_TXSXB().Db.Queryable<SZHL_TXSX>().Where(strWhere).OrderBy(it => it.CRDate, OrderByType.Desc).ToPageList(page, pagecount, ref total).ToDataTable();
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void GETTXSXMODEL(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void DELTXSX(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int FormID = Int32.Parse(P1);
        ...
        /// <param name="P2"></param>
        /// <param name="UserInfo"></param>
        public void GETTXSXDATAMONTH(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            string start = context["start"] != null ? context["start"].ToString() : "";
            string end = context["end"] != null ? context["end"].ToString() : "";
