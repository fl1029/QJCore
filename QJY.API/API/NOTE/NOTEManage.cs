...
namespace QJY.API
{
    public class NOTEManage 
    {
        ...
        public void GETNOTELIST(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            ...
            DataTable dt = new SZHL_NOTEB().GetDataPager(" SZHL_NOTE note inner join JH_Auth_ZiDian zd on LeiBie= zd.ID and Class=8  ", " note.ID,note.NoteTitle,note.NoteContent,note.LeiBie,note.CRDate,note.CRUser,note.UPUser,note.UPDDate,zd.TypeName ", 8, page, "CRDate desc", strWhere, ref recordCount);
        ...
        /// <param name="P2"></param>
        /// <param name="strUserName"></param>
        public void ADDNOTE(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
        ...
        public void DELNOTEBYID(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            try
            {
        ...
        public void GETNOTEMODEL(JObject context, Msg_Result msg, string P1, string P2, JH_Auth_UserB.UserInfo UserInfo)
        {
            int Id = 0;
