        ...
        <el-dialog title="组件属性" :visible.sync="dialogInputVisible">
            <el-form :model="childpro">
                ...
                <el-form-item label="上传样式">
                    <el-radio v-model="childpro.listtype" label="text">基础</el-radio>
                    <el-radio v-model="childpro.listtype" label="picture">图片</el-radio>
                    <el-radio v-model="childpro.listtype" label="picture-card">头像</el-radio>
                </el-form-item>
