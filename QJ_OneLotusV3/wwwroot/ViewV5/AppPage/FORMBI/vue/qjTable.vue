        ...
        <el-table :data="childpro.dataset" style="width: 100%" stripe border fit @header-dragend="widchange" :span-method="objectSpanMethod" :row-class-name="tableRowClassName" :summary-method="getSummaries" :show-summary="childpro.ishj">
            <el-table-column v-for="col in childpro.columdata" :label="col.colname" :key="col.colid" :width="col.width" min-width="120" align="center" :colid="col.colid" :show-overflow-tooltip="col.istip">
                <template slot-scope="scope">
                    ...
                    <el-select v-if="col.coltype=='el-select'" v-model="scope.row[col.colid]" placeholder="请选择" :disabled="childpro.disabled" filterable clearable>
                            ...
                            <table class="table table-bordered table-striped table-hover table-condensed">
                                ...
                                <tr v-if="el.coltype === 'el-select'">
                                    ...
                                    <td>
                                        ...
                                        <el-radio v-model="el.datatype" label="0" style="display: block;">自定义数据项</el-radio>
                                        <el-radio v-model="el.datatype" label="1" style="display: block;margin-left: 0;margin-top:5px">动态数据项</el-radio>
                                        <div class="panel panel-default" style="border: 1px solid #ddd;margin-top:10px" v-if="el.datatype === '0'">
                                        ...
                                        <div class="panel panel-default" style="border: 1px solid #ddd;margin-top:10px" v-if="el.datatype === '1'">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <el-button plain class="mt10" @click="VailSql(el)">验证</el-button>
                                            </div>
                                        </div>
...
<script>
    module.exports = {
        ...
        methods: {
            ...
            VailSql: function (el) {
                var chi = this;
                $.getJSON("/api/Bll/ExeAction?Action=FORMBI_GETSQLDATA", { P1: el.datasql }, function (result) {
                    if (!result.ErrorMsg) {
                        app.$notify({
                            title: '成功',
                            message: '加载数据成功',
