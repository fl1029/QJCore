    ...
    initForm: function () {
        ...
        if ($(".szhl_UEEDIT").length > 0) {
            ...
            $(".szhl_UEEDIT").each(function () {
                ...
                var umheight = $(this).attr("umheight")
                var um = UE.getEditor(ubid);
        ...
        if ($(".szhl_Upload:hidden").length > 0) {
            ...
            $(".szhl_Upload:hidden").each(function (index) {
                ...
                if ($input.val() != "") {
                    $.getJSON('/api/Bll/ExeAction?Action=QYWD_GETFILESLIST', { P1: $input.val() }, function (data) {
                        if (data.ErrorMsg == "") {
